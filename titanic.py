...
#Implementing the scikit learn library fot the Titanic dataset
...
#Creating the Logistic Regressio model
...
#Graph Representation of the Confusion Matrix using the Scikitlearn Library
